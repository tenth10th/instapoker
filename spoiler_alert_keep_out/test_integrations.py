...
def test_single_card_hands(h1, h2, expected_result):
    ...
    """
    hand_assertion_error_message = hand_error_str(h1, h2, expected_result)
    assert score_poker_hands(h1, h2) == expected_result, hand_assertion_error_message
...
def test_high_single_card_hands_10():
    ...
    """
    assert score_poker_hands("10H", "9S") == 1, "10H should win against 9S!"
...
def test_high_single_card_hands_T():
    ...
    """
    assert score_poker_hands("TH", "9S") == 1, "TH should win against 9S!"
